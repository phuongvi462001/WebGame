...
$sql_3 ="SELECT * FROM tbl_sanpham,tbl_thongke where tbl_sanpham.thutu=tbl_thongke.thutu and tbl_sanpham.gia_sanpham= 0 and tbl_thongke.rating_tb > 4 limit $b,6 ";
...
<ul >
  ...
  <li class="sotrang" <?php if ($i==$trang1){
    ...
    <a href="index.php?quanly=ungdungphobien&trang=<?php echo $i ?>"><?php echo $i ?></a>
  </li>
