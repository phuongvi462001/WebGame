...
$download_tmp=$_FILES['download']['tmp_name'];
$download=time().'_'.$download;



if (isset($_POST['themsanpham'])) {
	# thêm
	$sql_add="INSERT INTO tbl_sanpham(thutu,ten_sanpham,ma_sanpham,gia_sanpham,hinhanh,hinh_1,hinh_2,hinh_3,mota,thongtin,download,danhmuc,nhaphattrien) value('".$thutu."','".$tensanpham."','".$ma_sp."','".$gia_sp."','".$hinhanh."','".$hinhanh1."','".$hinhanh2."','".$hinhanh3."','".$mota."','".$thongtin."','".$download."','".$danhmuc."','".$nhaphattrien."')";
	...
	move_uploaded_file($download_tmp, '../../../Themes/left/files/'.$download);
